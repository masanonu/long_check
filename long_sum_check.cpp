...
long_sum_check::~long_sum_check(void)
{
  this->value01 = (long)NULL;
  this->value001 = (long)NULL;
  this->first = (long)NULL;
  this->sum_first = (long)NULL;
  this->sum = (long)NULL;
  this->result = (long)NULL;
  this->answer = (long)NULL;
  this->Judge = (bool)NULL;
}
void long_sum_check::setJudge(bool judge)
{
  this->Judge = judge;
}
bool long_sum_check::getJudge(void)
{
  return this->Judge;
}
void long_sum_check::setValue(long value1)
{
  this->value01 = 0;
  this->value001 = 0;
  this->sum_first = 0;
...
void long_sum_check::getResult(void)
{
...
long long_sum_check::getInput(void)
{
  return this->value01;
}
long long_sum_check::getAnswer(void)
{
  this->answer = this->value001 * 10 + this->sum_first;
  return this->answer;
}
void long_sum_check::space01(long value) {
  if (value < 10) {
    std::cout << "                             *" << std::endl;
  } else if (value < 100) {
    std::cout << "                            *" << std::endl;
...
void long_sum_check::space02(void)
{
  if (this->getJudge() != true)
    std::cout << "   *" << std::endl;
  else std::cout << "       *" << std::endl;
}
void long_sum_check::show(void)
{
  std::cout << "*********************************************" << std::endl;
  std::cout << "*    input  : " << this->getInput();
...
{
  std::cout << "This program calculate a corresponding first value of long sum at value." << std::endl;
